...
/*vector table */
/* special data moved to special user defined section called "isr_Vectors"*/
uint32_t vectors[MAX_VECTORS] __attribute__((used,section(".isr_vector"))) = 
{
	STACK_START,
	...
	(uint32_t)LCD_TFT_1_IRQHandler     
}; 

#if 1
//old implementation with ls.ld written by me
void Reset_Handler(void)
{
